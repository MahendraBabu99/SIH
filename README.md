...
- **Automated Dissect parsing.** AIFT automatically parses different forensic artefacts using Dissect. Even if AI-analysis fails, the analyst can still review all CSV's parsed by Dissect. 
...
### Configure AI
Configure a provider in the config, which can also be set via the GUI.
